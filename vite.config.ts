...
export default defineConfig(({ mode }) => {
    ...
    return {
      ...
      define: {
        ...
        'process.env.API_KEY_12': JSON.stringify(env.API_KEY_12 || ''),
        'process.env.API_KEY_13': JSON.stringify(env.API_KEY_13 || ''),
        'process.env.API_KEY_14': JSON.stringify(env.API_KEY_14 || ''),
        'process.env.API_KEY_15': JSON.stringify(env.API_KEY_15 || ''),
        'process.env.API_KEY_16': JSON.stringify(env.API_KEY_16 || ''),
        'process.env.API_KEY_17': JSON.stringify(env.API_KEY_17 || ''),
        'process.env.API_KEY_18': JSON.stringify(env.API_KEY_18 || ''),
        'process.env.API_KEY_19': JSON.stringify(env.API_KEY_19 || ''),
        'process.env.API_KEY_20': JSON.stringify(env.API_KEY_20 || ''),
        'process.env.API_KEY_21': JSON.stringify(env.API_KEY_21 || ''),
        'process.env.API_KEY_22': JSON.stringify(env.API_KEY_22 || ''),
      },
      resolve: {
        alias: {
